...
/***/ function(module, exports, __webpack_require__) {
	...
	var _distBundle = __webpack_require__(9);

	var _distBundle2 = _interopRequireDefault(_distBundle);
	...
	var Index = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var itemFn = function itemFn(props) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (true) module.exports = factory(__webpack_require__(2), __webpack_require__(6));else if (typeof define === 'function' && define.amd) define(["react", "react-dom"], factory);else if (typeof exports === 'object') exports["ReactOtocomplete"] = factory(require("react"), require("react-dom"));else root["ReactOtocomplete"] = factory(root["React"], root["ReactDOM"]);
					...
					_createClass(AutoComplete, [{
						...
						value: function render() {
							...
							var listItems = this.state.source.map(function (value, idx) {
								return _react2['default'].createElement('li', { key: 'typa_key_' + idx,
							...
							return _react2['default'].createElement(_srcTethered2['default'], {
								visible: this.state.visible,
								attachment: 'top left', // tether option
								targetAttachment: 'bottom left', // tether option
								attachmentElement: _react2['default'].createElement('div', null, list), // this element will be positioned absolute
					...
					_createClass(ReactTether, [{
						...
						value: function _tetherComponent() {
							...
							if (this.props.visible) {
								return _react2['default'].createElement('div', { className: className }, this.props.attachmentElement);
							}
	    ...
	    */
	     ...
	     * you may not use this file except in compliance with the License.
	     */
					var BitapSearcher = function BitapSearcher(pattern, options) {
						options = options || {};
	     ...
	     */
					...
					var deepValueHelper = function deepValueHelper(obj, path, list) {
	     ...
	     */
	      ...
	      * @private
	      */
						var analyzeText = function analyzeText(text, entity, index) {
